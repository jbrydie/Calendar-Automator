...
''' Each color will correspond to an even, whcich is on my calender. All events a color coded according 
    to the event type (i.e. time allocated for working out is always Peackock)'''
